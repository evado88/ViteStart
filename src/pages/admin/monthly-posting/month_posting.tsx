...
const AdminMonthlyPosting = ({ props }: any) => {
  ...
  const updateVaues = (res: any) => {
    setFirstName(res.user.fname);
    setLastName(res.user.lname);

    setPostingDate(res.saving);
    setPostingSavings(res.saving);
    setPostingShares(res.shares);
    setPostingSocial(res.social);
    setPostingPenalty(res.penalty);

    setPostingLoanInterestPayment(res.loan_interest);
    setPostingLoanAmountPayment(res.loan_amount_payment);
    setPostingLoanMonthPayment(res.loan_month_repayment);
    setPostingLoanApplication(res.loan_application);
    setPostingComments(res.comments);
