...
const AdminLoans = () => {
  ...
  const pageConfig = new PageConfig(
    ...
    `transactions/type/${Assist.TRANSACTION_LOAN}/status/${Assist.STATUS_APPROVED}/year/${periodYear}`,
    "",
    "Loan",
    "",
    [Assist.ROLE_ADMIN],
  ...
  const loadData = (year: number) => {
    ...
    const url = `transactions/type/${Assist.TRANSACTION_LOAN}/status/${Assist.STATUS_APPROVED}/year/${year}`;
