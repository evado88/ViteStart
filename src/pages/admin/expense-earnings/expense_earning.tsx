...
import { ExpenseEarningDetail } from "../../../components/expenseEarningDetail";
...
const AdminMeeting = () => {
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Expense / Earning`,
    "",
    "",
    "Expense / Earning",
    ...
    <div id="pageRoot" className="page-content">
      ...
      <Row>
        <Col sz={12} sm={12} lg={7}>
          {meetingDetail != null && (
            <ExpenseEarningDetail
              transaction={meetingDetail}
