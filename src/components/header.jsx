            ...
            <ul className="nav navbar-nav pull-right">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{"background":"rgb(158, 165, 171)","width":"5px","position":"absolute","top":"0px","opacity":"0.4","display":"block","borderRadius":"7px","zIndex":"99","right":"1px"}}
                      ></div>
                      <div
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div
                        className="slimScrollRail"
                        style={{"width":"5px","height":"100%","position":"absolute","top":"0px","display":"none","borderRadius":"7px","background":"rgb(51, 51, 51)","opacity":"0.2","zIndex":"90","right":"1px"}}></div>
                    </div>
                    <div className="dropdown-menu-footer">
                      <a
                        href="https://www.einfosoft.com/templates/admin/smart/source/light/dashboard3.html#"
              ...
              <li className="dropdown dropdown-user">
                ...
                <ul className="dropdown-menu dropdown-menu-default">
                  <li>
                    <a
                      href="https://www.einfosoft.com/templates/admin/smart/source/light/user_profile.html"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.einfosoft.com/templates/admin/smart/source/light/lock_screen.html"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.einfosoft.com/templates/admin/smart/source/light/login.html"
                    >
